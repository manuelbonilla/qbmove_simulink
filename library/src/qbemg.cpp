...
//============================================================      qbot ID check
     ...
     out_emg_a[i]    = dwork_out(i)[0];
     out_emg_b[i]    = dwork_out(i)[1];

     if(!commGetEmg(&comm_settings_t, qbot_id, emg))
     {
         out_emg_a[i] = (double) emg[0];
         out_emg_b[i] = (double) emg[1];


         dwork_out(i)[0] = out_emg_a[i];
         dwork_out(i)[1] = out_emg_b[i];
     }
    }
